...
exports.hardFilterTestCases = exports.edgeCaseTrainers = exports.seedTrainers = exports.seedClients = void 0;
exports.seedClients = [
    {
...
exports.hardFilterTestCases = [
    // Unavailable trainer
    {
        userId: 'trainer-unavailable',
        userType: 'trainer',
        answers: exports.seedTrainers[0].answers, // Same as cardio expert
        completedAt: new Date(),
        metadata: {
            certification: 'certified',
    ...
    // Both filters failed
    {
        ...
        userType: 'trainer',
        answers: exports.seedTrainers[0].answers,
        completedAt: new Date(),
        metadata: {
...
exports.default = {
    seedClients: exports.seedClients,
    seedTrainers: exports.seedTrainers,
    edgeCaseTrainers: exports.edgeCaseTrainers,
    hardFilterTestCases: exports.hardFilterTestCases
};
